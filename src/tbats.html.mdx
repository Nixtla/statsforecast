...
<a
href="https://github.com/Nixtla/statsforecast/blob/main/statsforecast/tbats.py#L834"
...
<a
href="https://github.com/Nixtla/statsforecast/blob/main/statsforecast/tbats.py#L914"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/statsforecast/blob/main/statsforecast/tbats.py#L993"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
