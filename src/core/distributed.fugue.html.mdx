...
<a
href="https://github.com/Nixtla/statsforecast/blob/main/statsforecast/distributed/fugue.py#L58"
...
<a
href="https://github.com/Nixtla/statsforecast/blob/main/statsforecast/distributed/fugue.py#L296"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
| fallback_model       | Optional     | Any, optional (default=None)<br/>Model to be used if a model fails.<br/>Only works with the [`forecast`](https://Nixtla.github.io/statsforecast/src/ets.html#forecast) and `cross_validation` methods. |
...
<a
href="https://github.com/Nixtla/statsforecast/blob/main/statsforecast/distributed/fugue.py#L458"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
