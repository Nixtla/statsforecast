...
`blambda` | <code>Optional\[Union[float, str]\], default=None</code> | Box-Cox transformation parameter. If 'auto', it is selected with Guerrero's method over [-0.9, 2]. No transformation is applied if None. | <code>None</code>
