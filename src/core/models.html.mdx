...
```python
HistoricAverage(alias='HistoricAverage', prediction_intervals=None, distribution='gaussian')
```
...
```python
Naive(alias='Naive', prediction_intervals=None, distribution='gaussian')
```
...
```python
RandomWalkWithDrift(alias='RWD', prediction_intervals=None, distribution='gaussian')
```
...
```python
SeasonalNaive(season_length, alias='SeasonalNaive', prediction_intervals=None, distribution='gaussian')
```
