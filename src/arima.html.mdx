...
<a
href="https://github.com/Nixtla/statsforecast/blob/main/statsforecast/arima.py#L1902"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/statsforecast/blob/main/statsforecast/arima.py#L1932"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
