...
__all__ = ['linear_auto_regression', 'ses', 'adida', 'historic_average', 'croston_classic', 'croston_sba',
...
# Cell
def linear_auto_regression(X, h, future_xreg, tau, ar_terms,
                             add_constant=True,
                             max_diffs=10):
