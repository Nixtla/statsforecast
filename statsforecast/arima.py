...
__all__ = ['partrans', 'arima_gradtrans', 'arima_undopars', 'tsconv', 'inclu2', 'invpartrans', 'arima_undopars',
           'ARIMA_invtrans', 'getQ0', 'arima_transpar', 'arima_css', 'make_arima', 'arima_like', 'diff1d', 'diff2d',
           'diff', 'OptimResult', 'arima', 'kalman_forecast', 'checkarima', 'myarima', 'search_arima', 'Arima',
           'is_constant', 'mstl', 'seas_heuristic', 'nsdiffs', 'ndiffs', 'newmodel', 'auto_arima', 'predict']
...
# Cell
def predict(model, n_ahead, newxreg = None, se_fit=True):
