---
title: Distributed Forecast of 1M Time Series in Under 15 Minutes with Spark, Nixtla, and Fugue
description: Scalable Time Series Modeling with open-source projects StatsForecast, Fugue, and Spark 
order: 3
execute:
  echo: false
  output: asis
...
By [Fugue](https://github.com/fugue-project/) and [Nixtla](https://github.com/nixtla/). Originally posted in [TDS](https://medium.com/towards-data-science/distributed-forecast-of-1m-time-series-in-under-15-minutes-with-spark-nixtla-and-fugue-e9892da6fd5c).
