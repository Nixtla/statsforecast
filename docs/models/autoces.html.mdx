...
\${}\_0+i{}\_1 \$ and 1 by $1+i$ to introduce the harmonically declining
weights. Depending on the values of the complex smoothing parameter, the
weights distribution will exhibit a variety of trajectories over time,
including exponential, oscillating, and harmonic. Finally, the result of
multiplication of two complex numbers will be another complex number, so
we substitute ${\hat{y}}_{t-j}$ with ${\hat{y}}_{t-j}+i{\hat{e}}_{t-j}$,
where ${\hat{e}}_{t-j}$ is the proxy for the error term. The CES
obtained as a result of this can be written as:
...
![](/docs/models/AutoCES_files/figure-markdown_strict/cell-8-output-1.png)
...
![](/docs/models/AutoCES_files/figure-markdown_strict/cell-9-output-1.png)
...
![](/docs/models/AutoCES_files/figure-markdown_strict/cell-10-output-1.png)
...
![](/docs/models/AutoCES_files/figure-markdown_strict/cell-13-output-1.png)
...
![](/docs/models/AutoCES_files/figure-markdown_strict/cell-20-output-1.png)
...
![](/docs/models/AutoCES_files/figure-markdown_strict/cell-23-output-1.png)
...
![](/docs/models/AutoCES_files/figure-markdown_strict/cell-27-output-1.png)
...
![](/docs/models/AutoCES_files/figure-markdown_strict/cell-32-output-1.png)
...
![](/docs/models/AutoCES_files/figure-markdown_strict/cell-33-output-1.png)
