...
![](/statsforecast/docs/models/HoltWinters_files/figure-markdown_strict/cell-29-output-1.png)
...
![](/statsforecast/docs/models/HoltWinters_files/figure-markdown_strict/cell-35-output-1.png)

```python
plot_forecasts(df, forecast_df, models=["Multi"])
```

![](/statsforecast/docs/models/HoltWinters_files/figure-markdown_strict/cell-36-output-1.png)
...
![](/statsforecast/docs/models/HoltWinters_files/figure-markdown_strict/cell-37-output-1.png)
