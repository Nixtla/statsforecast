---
title: GARCH Model Reference and Volatility Concepts
description: Understand GARCH model equations, assumptions, parameters, diagnostics, and forecast behavior in the StatsForecast Python implementation.
---
