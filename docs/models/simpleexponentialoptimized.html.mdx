...
![](/docs/models/SimpleExponentialOptimized_files/figure-markdown_strict/cell-7-output-1.png)
...
![](/docs/models/SimpleExponentialOptimized_files/figure-markdown_strict/cell-8-output-1.png)
...
![](/docs/models/SimpleExponentialOptimized_files/figure-markdown_strict/cell-11-output-1.png)
...
![](/docs/models/SimpleExponentialOptimized_files/figure-markdown_strict/cell-18-output-1.png)
...
![](/docs/models/SimpleExponentialOptimized_files/figure-markdown_strict/cell-21-output-1.png)
...
![](/docs/models/SimpleExponentialOptimized_files/figure-markdown_strict/cell-26-output-1.png)
...
![](/docs/models/SimpleExponentialOptimized_files/figure-markdown_strict/cell-27-output-1.png)
