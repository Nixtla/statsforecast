...
visit the
[documentation](https://nixtlaverse.nixtla.io/statsforecast/docs/models/CrostonClassic)
...
3.  [James D. Hamilton. Time Series Analysis Princeton University Press,
    ...
    1994.](https://press.princeton.edu/books/hardcover/9780691042893/time-series-analysis)
4.  [Nixtla
    Parameters](https://nixtlaverse.nixtla.io/statsforecast/docs/models/CrostonClassic)
5.  [Pandas available
    frequencies](https://pandas.pydata.org/pandas-docs/stable/user_guide/timeseries.html#offset-aliases).
