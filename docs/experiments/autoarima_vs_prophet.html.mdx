...
![](AutoArima_vs_Prophet_files/figure-markdown_strict/cell-31-output-1.png)

### Evaluation

### Time

It is useful to calculate the time for just one time series to
...
![](AutoArima_vs_Prophet_files/figure-markdown_strict/cell-36-output-1.png)
