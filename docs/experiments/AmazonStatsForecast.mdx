...
found [here](./docs/experiments/AmazonStatsForecast).
...
A detailed description of the particular steps for this dataset can be
found
[here](https://nixtlaverse.nixtla.io/statsforecast/docs/experiments/AmazonStatsForecast).
...
-   `models`: a list of models. Select the models you want from
    [models](../../models) and import them. For this example, we will
