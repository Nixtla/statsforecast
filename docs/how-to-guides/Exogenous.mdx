...
incorporate exogenous regressors into [StatsForecast](../../models)’s
models. Furthermore, you’ll see how to evaluate their performance and
decide whether or not they can help enhance the forecast.
...
> <a href="https://colab.research.google.com/github/Nixtla/statsforecast/blob/main/nbs/docs/experiments/Exogenous.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
...
multiple parameters, and the requiered ones to generate the plots in
this notebook are explained below.
...
![](Exogenous_files/figure-markdown_strict/cell-9-output-1.png)
...
![](Exogenous_files/figure-markdown_strict/cell-17-output-1.png)
