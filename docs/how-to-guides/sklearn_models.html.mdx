...
`statsforecast.models.SklearnModel` wrapper. This can help you leverage
feature engineering and train one model per serie, which can sometimes
be better than training a single global model (as in mlforecast).
...
engineering](../../../utilsforecast/feature_engineering.html).
...
![](./sklearn_models_files/figure-markdown_strict/cell-6-output-1.png)
