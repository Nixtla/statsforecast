...
![](1_Getting_Started_short_files/figure-markdown_strict/cell-8-output-1.png)

> **Next Steps**
>
> -   Build and end-to-end forecasting pipeline following best practices
>     in [End to End Walkthrough](./2_Getting_Started_complete)
> -   [Forecast millions of series](../how-to-guides/Prophet_spark_m5)
>     in a scalable cluster in the cloud using Spark and Nixtla
