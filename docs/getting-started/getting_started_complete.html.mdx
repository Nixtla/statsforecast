---
title: End to End Walkthrough | StatsForecast
---
...
> example visit the [Quick Start](./1_Getting_Started_short).
...
>     -   [Forecast the M5 Dataset in 5min](../experiments/ETS_ray_m5)
>         using Ray clusters.
>     -   [Forecast the M5 Dataset in
>         5min](../experiments/Prophet_spark_m5) using Spark clusters.
...
>         forecasting](../tutorials/ElectricityLoadForecasting)
>         tutorial.
> -   Using external regressors or exogenous variables
>     -   Follow this tutorial to [include exogenous
>         variables](../how-to-guides/Exogenous) like weather or
...
instructions on [how to install StatsForecast](./0_Installation).
...
![](getting_Started_complete_files/figure-markdown_strict/cell-8-output-1.png)
...
-   `models`: a list of models. Select the models you want from
    [models](../../src/core/models_intro) and import them.
...
`>>>>>>> f262b71470cd5bd4105e3701c8088b848f98a7af`
...
![](getting_Started_complete_files/figure-markdown_strict/cell-13-output-1.png)
...
|     | unique_id | cutoff | HoltWinters   | CrostonClassic | SeasonalNaive | HistoricAverage | DynamicOptimizedTheta | best_model     |
|-----|-----------|--------|---------------|----------------|---------------|-----------------|-----------------------|----------------|
| 0   | H1        | 700    | 38009.958333  | 28751.156365   | 1517.500000   | 23823.193125    | 1595.491947           | SeasonalNaive  |
| 1   | H10       | 700    | 2617.458333   | 1429.094499    | 89.375000     | 1833.382222     | 397.616596            | SeasonalNaive  |
| 2   | H100      | 700    | 104198.500000 | 80556.697053   | 8313.250000   | 71869.350278    | 28936.963781          | SeasonalNaive  |
| 3   | H101      | 700    | 19922.958333  | 6907.766752    | 13607.708333  | 9870.140347     | 107823.332195         | CrostonClassic |
| 4   | H102      | 700    | 264394.791667 | 144611.993865  | 9206.166667   | 350475.255208   | 32221.379750          | SeasonalNaive  |
...
![](getting_Started_complete_files/figure-markdown_strict/cell-22-output-1.png)
...
|-----|-----------|-----|------------|------------------|------------------|
| 0   | H1        | 749 | 635.000000 | 566.036734       | 703.963266       |
| 1   | H1        | 749 | 592.701851 | 577.677280       | 611.652639       |
| 2   | H1        | 750 | 572.000000 | 503.036734       | 640.963266       |
| 3   | H1        | 750 | 525.589117 | 505.449755       | 546.621805       |
| 4   | H1        | 751 | 532.000000 | 463.036734       | 600.963266       |
...
![](getting_Started_complete_files/figure-markdown_strict/cell-25-output-1.png)
