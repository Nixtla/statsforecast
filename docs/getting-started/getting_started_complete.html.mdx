...
![](/statsforecast/docs/getting-started/2_Getting_Started_complete_files/figure-markdown_strict/cell-7-output-1.png)
...
> The
> [`forecast`](https://Nixtla.github.io/statsforecast/src/ets.html#forecast)
> method is compatible with distributed clusters, so it does not store
> any model parameters. If you want to store parameters for every model
> you can use the `fit` and `predict` methods. However, those methods
> are not defined for distrubed engines like Spark, Ray or Dask.
...
![](/statsforecast/docs/getting-started/2_Getting_Started_complete_files/figure-markdown_strict/cell-14-output-1.png)
...
![](/statsforecast/docs/getting-started/2_Getting_Started_complete_files/figure-markdown_strict/cell-21-output-1.png)
...
![](/statsforecast/docs/getting-started/2_Getting_Started_complete_files/figure-markdown_strict/cell-24-output-1.png)
