---
title: Quick Start | StatsForecast
---
...
> series](../../2_Getting_Started_complete) guide.
...
[two required parameters](../../models): \* `models`: a list of models.
Select the models you want from [models](../../models) and import them.
For this example, we will use a `AutoARIMA` model. We set
`season_length` to 12 because we expect seasonal effects every 12
months. (See: [Seasonal
...
![](getting_Started_short_files/figure-markdown_strict/cell-8-output-1.png)

> **Next Steps**
>
> -   Build and end-to-end forecasting pipeline following best practices
>     in [End to End Walkthrough](./2_Getting_Started_complete)
> -   [Forecast millions of series](../experiments/Prophet_spark_m5) in
>     a scalable cluster in the cloud using Spark and Nixtla
> -   [Detect anomalies](../tutorials/AnomalyDetection) in your past
>     observations
