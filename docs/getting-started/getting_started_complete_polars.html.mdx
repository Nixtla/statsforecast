...
-   Forecasting at scale using clusters on the cloud.
    -   [Forecast the M5 Dataset in 5min](./ets_ray_m5.html) using Ray
        clusters.
    -   [Forecast the M5 Dataset in 5min](./prophet_spark_m5.html)
...
-   Training models on Multiple Seasonalities.
    -   Learn to use multiple seasonality in this [Electricity Load
        forecasting](./electricityloadforecasting.html) tutorial.
-   Using external regressors or exogenous variables
    -   Follow this tutorial to [include exogenous
        variables](./exogenous.html) like weather or holidays or static
...
![](/docs/getting-started/3_Getting_Started_complete_polars_files/figure-markdown_strict/cell-5-output-2.png)
...
![](/docs/getting-started/3_Getting_Started_complete_polars_files/figure-markdown_strict/cell-10-output-2.png)
...
![](/docs/getting-started/3_Getting_Started_complete_polars_files/figure-markdown_strict/cell-19-output-1.png)
...
![](/docs/getting-started/3_Getting_Started_complete_polars_files/figure-markdown_strict/cell-22-output-1.png)
