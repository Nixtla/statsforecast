...
suggest documentation improvements, please visit the [StatsForecast
GitHub issues page](https://github.com/Nixtla/statsforecast/issues).
Before submitting a new issue, kindly check if it has already been
reported.
...
page](https://github.com/Nixtla/statsforecast/issues) and click on the
*New issue* button.
