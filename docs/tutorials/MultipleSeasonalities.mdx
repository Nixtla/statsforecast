...
The [MSTL](../models/MultipleSeasonalTrend) (Multiple Seasonal-Trend
decompositions using LOESS) model, originally developed by [Kasun
Bandara, Rob J Hyndman and Christoph
...
seasonality using a [SeasonalNaive](../../models#class-seasonalnaive)
...
series](../getting-started/2_Getting_Started_complete).
...
-   Learn how to [use cross-validation to assess the robustness of your
    model](../getting-started/2_Getting_Started_complete#evaluate-the-model%E2%80%99s-performance)
