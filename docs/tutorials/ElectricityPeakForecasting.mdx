...
> [here](https://nixtlaverse.nixtla.io/statsforecast/docs/tutorials/MultipleSeasonalities)
...
[here](https://nixtlaverse.nixtla.io/statsforecast/models).
...
tutorial](https://nixtlaverse.nixtla.io/statsforecast/docs/getting-started/2_Getting_Started_complete)
