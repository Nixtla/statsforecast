...
> [Prediction Intervals](./UncertaintyIntervals).
...
[Statsforecast](../../index) now supports Conformal Prediction on all
available models.
...
[SimpleExponentialSmoothing](../models/SimpleExponentialSmoothing) and
[ADIDA](../models/ADIDA) which do not provide a prediction interval
natively. Thus, it makes sense to use Conformal Prediction to generate
the prediction interval.

We’ll also show using it with [ARIMA](../models/ARIMA) to provide
prediction intervals that don’t assume normality.
