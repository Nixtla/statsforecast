...
> Start](https://nixtlaverse.nixtla.io/statsforecast/docs/getting-started/1_Getting_Started_short)
...
[StatsForecast](https://nixtlaverse.nixtla.io/statsforecast/) and how
they can be used to analyze and predict financial time series data.
...
StatsForecast](https://nixtlaverse.nixtla.io/statsforecast/docs/getting-started/0_Installation)
...
![](GARCH_tutorial_files/figure-markdown_strict/cell-9-output-1.png)
...
![](GARCH_tutorial_files/figure-markdown_strict/cell-11-output-1.png)
...
[GARCH](https://nixtlaverse.nixtla.io/statsforecast/docs/models/GARCH)
and the
[ARCH](https://nixtlaverse.nixtla.io/statsforecast/docs/models/ARCH)
models from `statsforecast.models`, and then we need to fit them by
instantiating a new StatsForecast object. Notice that we’ll be using
different values of $p$ and $q$. In the next section, we’ll determine
which ones produce the most accurate model using cross-validation. We’ll
also import the
[Naive](https://nixtlaverse.nixtla.io/statsforecast/models#class-naive)
model since we’ll use it as a baseline.
...
![](GARCH_tutorial_files/figure-markdown_strict/cell-16-output-1.png)

A tutorial on cross-validation can be found
[here](https://nixtlaverse.nixtla.io/statsforecast/docs/tutorials/CrossValidation)
