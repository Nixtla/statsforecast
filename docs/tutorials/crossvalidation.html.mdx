---
title: Cross validation | StatsForecast
---
...
For this example, we’ll use StatsForecast [AutoETS](../models/AutoETS).
...
-   n_jobs: int, number of jobs used in the parallel processing, use -1
    for all cores.
...
> Here’s an [example](../getting-started/2_Getting_Started_complete)
