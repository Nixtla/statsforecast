...
AutoETS), check [Prediction Intervals](./uncertaintyintervals.html).
...
> **Tip**
>
> StatsForecast also includes
> [`ConformalSeasonalPool`](../models/conformalseasonalpool.html), a
> training-free seasonal model whose prediction intervals are *natively*
> conformal.
...
[StatsForecast](../../index.html) implements conformal prediction for
...
-   **[SeasonalExponentialSmoothing](../../src/core/models.html#SimpleExponentialSmoothing)**:
    A simple smoothing model
-   **[ADIDA](../../src/core/models.html#adida)**: Aggregation method
    for intermittent demand
-   **[ARIMA](../../src/core/models.html#ARIMA)**: Traditional
    statistical model (to show distribution-free intervals)
...
-   Explore [advanced uncertainty quantification
    methods](./uncertaintyintervals.html)
