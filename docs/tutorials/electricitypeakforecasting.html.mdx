---
title: Detect Demand Peaks | StatsForecast
---
...
> [here](../tutorials/MultipleSeasonalities)
...
list of models is available [here](../../models).
...
tutorial](../getting-started/2_Getting_Started_complete) for an
...
tutorial](../../../neuralforecast/use-cases/electricitypeakforecasting).
