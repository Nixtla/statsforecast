...
[StatsForecast](https://nixtlaverse.nixtla.io/statsforecast/) has
implemented several models to forecast intermittent time series. By the
end of this tutorial, you’ll have a good understanding of these models
and how to use them.
...
![](IntermittentData_files/figure-markdown_strict/cell-8-output-1.png)
...
[here](https://nixtlaverse.nixtla.io/statsforecast/docs/models.html#sparse-or-intermittent).
In this notebook, we’ll use:

-   [Agregate-Dissagregate Intermittent Demand Approach
    (ADIDA)](https://nixtlaverse.nixtla.io/statsforecast/docs/models/ADIDA)
-   [Croston
    Classic](https://nixtlaverse.nixtla.io/statsforecast/docs/models/CrostonClassic)
-   [Intermittent Multiple Aggregation Prediction Algorithm
    (IMAPA)](https://nixtlaverse.nixtla.io/statsforecast/docs/models/IMAPA)
-   [Teunter-Syntetos-Babai
    (TSB)](https://nixtlaverse.nixtla.io/statsforecast/docs/models/TSB)
...
model](https://nixtlaverse.nixtla.io/statsforecast/models) should be
used.
...
![](IntermittentData_files/figure-markdown_strict/cell-15-output-1.png)
