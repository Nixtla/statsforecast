...
[StatsForecast](../../index) has implemented several models to forecast
intermittent time series. By the end of this tutorial, you’ll have a
...
[here](../../models). In this notebook, we’ll use:
...
are needed, then a [probabilisitic model](../../models) should be used.
