...
[Statsforecast](https://nixtlaverse.nixtla.io/statsforecast/) has an
...
![](CrossValidation_files/figure-markdown_strict/cell-7-output-1.png)
...
-   models: a list of models. Select the models you want from
    [models](https://nixtlaverse.nixtla.io/statsforecast/models/) and
    import them.
...
![](CrossValidation_files/figure-markdown_strict/cell-13-output-1.png)

![](CrossValidation_files/figure-markdown_strict/cell-13-output-2.png)

![](CrossValidation_files/figure-markdown_strict/cell-13-output-3.png)
...
> Here’s an
> [example](https://nixtlaverse.nixtla.io/statsforecast/docs/getting-started/2_Getting_Started_complete)
