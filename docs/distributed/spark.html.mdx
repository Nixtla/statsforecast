...
Current guidance for distributed forecasting with Spark is available in
the [Fugue backend
documentation](https://nixtlaverse.nixtla.io/statsforecast/src/core/distributed.fugue.html).
