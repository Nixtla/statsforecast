...
Vist our [Installation Guide](./statsforecast/docs/getting-started/0_Installation) for further instructions.
...
**Get Started with this [quick guide](./statsforecast/docs/getting-started/1_Getting_Started_short)**

**Follow this [end-to-end walkthrough](./statsforecast/docs/getting-started/2_Getting_Started_complete) for best practices.**
...
📚 [End to End Walkthrough](./statsforecast/docs/getting-started/2_Getting_Started_complete): Model training, evaluation and selection for multiple time series

🔎 [Anomaly Detection](./statsforecast/docs/tutorials/AnomalyDetection): detect anomalies for time series using in-sample prediction intervals.

👩‍🔬 [Cross Validation](./statsforecast/docs/tutorials/CrossValidation): robust model’s performance evaluation.

❄️ [Multiple Seasonalities](./statsforecast/docs/tutorials/MultipleSeasonalities): how to forecast data with multiple seasonalities using an MSTL.

🔌 [Predict Demand Peaks](./statsforecast/docs/tutorials/ElectricityPeakForecasting): electricity load forecasting for detecting daily peaks and reducing electric bills.

📈 [Intermittent Demand](./statsforecast/docs/tutorials/IntermittentData): forecast series with very few non-zero observations.

🌡️ [Exogenous Regressors](./statsforecast/docs/how-to-guides/Exogenous): like weather or prices
...
|:------|:-------------:|:----------------------:|:---------------------:|:----------------------------:|:----------------:|
|[AutoARIMA](./statsforecast/models#class-autoarima)|✅|✅|✅|✅|✅|
|[AutoETS](./statsforecast/models#class-autoets)|✅|✅|✅|✅||
|[AutoCES](./statsforecast/models#class-autoces)|✅|✅|✅|✅||
|[AutoTheta](./statsforecast/models#class-autotheta)|✅|✅|✅|✅||
|[AutoMFLES](./statsforecast/models#class-automfles)|✅|✅|✅|✅|✅|
|[AutoTBATS](./statsforecast/models#class-autotbats)|✅|✅|✅|✅||
...
|Model | Point Forecast | Probabilistic Forecast | Insample fitted values | Probabilistic fitted values |Exogenous features|
|:------|:-------------:|:----------------------:|:---------------------:|:----------------------------:|:----------------:|
|[ARIMA](./statsforecast/models#class-arima)|✅|✅|✅|✅|✅|
|[AutoRegressive](./statsforecast/models#class-autoregressive)|✅|✅|✅|✅|✅|
...
|Model | Point Forecast | Probabilistic Forecast | Insample fitted values | Probabilistic fitted values |Exogenous features|
|:------|:-------------:|:----------------------:|:---------------------:|:----------------------------:|:----------------:|
|[Theta](./statsforecast/models#class-theta)|✅|✅|✅|✅|✅|
|[OptimizedTheta](./statsforecast/models#class-optimizedtheta)|✅|✅|✅|✅||
|[DynamicTheta](./statsforecast/models#class-dynamictheta)|✅|✅|✅|✅||
|[DynamicOptimizedTheta](./statsforecast/models#class-dynamicoptimizedtheta)|✅|✅|✅|✅||
...
|Model | Point Forecast | Probabilistic Forecast | Insample fitted values | Probabilistic fitted values |Exogenous features|
|:------|:-------------:|:----------------------:|:---------------------:|:----------------------------:|:----------------:|
|[MSTL](./statsforecast/models#class-mstl)|✅|✅|✅|✅|If trend forecaster supports|
|[MFLES](./statsforecast/models#class-mfles)|✅|✅|✅|✅|✅|
|[TBATS](./statsforecast/models#class-tbats)|✅|✅|✅|✅||
...
|Model | Point Forecast | Probabilistic Forecast | Insample fitted values | Probabilistic fitted values |Exogenous features|
|:------|:-------------:|:----------------------:|:---------------------:|:----------------------------:|:----------------:|
|[GARCH](./statsforecast/models#class-garch)|✅|✅|✅|✅||
|[ARCH](./statsforecast/models#class-arch)|✅|✅|✅|✅||
...
|Model | Point Forecast | Probabilistic Forecast | Insample fitted values | Probabilistic fitted values |Exogenous features|
|:------|:-------------:|:----------------------:|:---------------------:|:----------------------------:|:----------------:|
|[HistoricAverage](./statsforecast/models#class-historicaverage)|✅|✅|✅|✅||
|[Naive](./statsforecast/models#class-naive)|✅|✅|✅|✅||
|[RandomWalkWithDrift](./statsforecast/models#class-randomwalkwithdrift)|✅|✅|✅|✅||
|[SeasonalNaive](./statsforecast/models#class-seasonalnaive)|✅|✅|✅|✅||
|[WindowAverage](./statsforecast/models#class-windowaverage)|✅|||||
|[SeasonalWindowAverage](./statsforecast/models#class-seasonalwindowaverage)|✅|||||
...
|Model | Point Forecast | Probabilistic Forecast | Insample fitted values | Probabilistic fitted values |Exogenous features|
|:------|:-------------:|:----------------------:|:---------------------:|:----------------------------:|:----------------:|
|[SimpleExponentialSmoothing](./statsforecast/models#class-simpleexponentialsmoothing)|✅||✅|||
|[SimpleExponentialSmoothingOptimized](./statsforecast/models#class-simpleexponentialsmoothingoptimized)|✅||✅|||
|[SeasonalExponentialSmoothing](./statsforecast/models#class-seasonalexponentialsmoothing)|✅||✅|||
|[SeasonalExponentialSmoothingOptimized](./statsforecast/models#class-seasonalexponentialsmoothingoptimized)|✅||✅|||
|[Holt](./statsforecast/models#class-holt)|✅|✅|✅|✅||
|[HoltWinters](./statsforecast/models#class-holtwinters)|✅|✅|✅|✅||
...
|Model | Point Forecast | Probabilistic Forecast | Insample fitted values | Probabilistic fitted values |Exogenous features|
|:------|:-------------:|:----------------------:|:---------------------:|:----------------------------:|:----------------:|
|[ADIDA](./statsforecast/models#class-adida)|✅||✅|✅||
|[CrostonClassic](./statsforecast/models#class-crostonclassic)|✅||✅|✅||
|[CrostonOptimized](./statsforecast/models#class-crostonoptimized)|✅||✅|✅||
|[CrostonSBA](./statsforecast/models#class-crostonsba)|✅||✅|✅||
|[IMAPA](./statsforecast/models#class-imapa)|✅||✅|✅||
|[TSB](./statsforecast/models#class-tsb)|✅||✅|✅||
