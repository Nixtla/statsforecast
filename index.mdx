...
Vist our [Installation Guide](./docs/getting-started/0_Installation) for further instructions.
...
**Get Started with this [quick guide](./docs/getting-started/1_Getting_Started_short)**

**Follow this [end-to-end walkthrough](./docs/getting-started/2_Getting_Started_complete) for best practices.**
...
📚 [End to End Walkthrough](./docs/getting-started/2_Getting_Started_complete): Model training, evaluation and selection for multiple time series

🔎 [Anomaly Detection](./docs/tutorials/AnomalyDetection): detect anomalies for time series using in-sample prediction intervals.

👩‍🔬 [Cross Validation](./docs/tutorials/CrossValidation): robust model’s performance evaluation.

❄️ [Multiple Seasonalities](./docs/tutorials/MultipleSeasonalities): how to forecast data with multiple seasonalities using an MSTL.

🔌 [Predict Demand Peaks](./docs/tutorials/ElectricityPeakForecasting): electricity load forecasting for detecting daily peaks and reducing electric bills.

📈 [Intermittent Demand](./docs/tutorials/IntermittentData): forecast series with very few non-zero observations.

🌡️ [Exogenous Regressors](./docs/how-to-guides/Exogenous): like weather or prices
...
|:------|:-------------:|:----------------------:|:---------------------:|:----------------------------:|:----------------:|
|[AutoARIMA](./docs/models/AutoARIMA)|✅|✅|✅|✅|✅|
|[AutoETS](./docs/models/AutoETS)|✅|✅|✅|✅||
|[AutoCES](./docs/models/AutoCES)|✅|✅|✅|✅||
|[AutoTheta](./docs/models/AutoTheta)|✅|✅|✅|✅||
|[AutoMFLES](./models#class-automfles)|✅|✅|✅|✅|✅|
|[AutoTBATS](./models#class-autotbats)|✅|✅|✅|✅||
...
|Model | Point Forecast | Probabilistic Forecast | Insample fitted values | Probabilistic fitted values |Exogenous features|
|:------|:-------------:|:----------------------:|:---------------------:|:----------------------------:|:----------------:|
|[ARIMA](./docs/models/ARIMA)|✅|✅|✅|✅|✅|
|[AutoRegressive](./docs/models/AutoRegressive)|✅|✅|✅|✅|✅|
...
|Model | Point Forecast | Probabilistic Forecast | Insample fitted values | Probabilistic fitted values |Exogenous features|
|:------|:-------------:|:----------------------:|:---------------------:|:----------------------------:|:----------------:|
|[MSTL](./models#class-mstl)|✅|✅|✅|✅|If trend forecaster supports|
|[MFLES](./models#class-mfles)|✅|✅|✅|✅|✅|
|[TBATS](./models#class-tbats)|✅|✅|✅|✅||
...
|[SeasonalExponentialSmoothing](./models#class-seasonalexponentialsmoothing)|✅||✅|||
|[SeasonalExponentialSmoothingOptimized](./models#class-seasonalexponentialsmoothingoptimized)|✅||✅|||
